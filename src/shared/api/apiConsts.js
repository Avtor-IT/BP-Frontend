...
export const apiEndpoints = {
	...
	CHAT_ROOM: `/api/chat/${version}/:b24_user_id/`,
	CHAT_MESSAGES: `/api/chat/${version}/:chat_room_id/messages/`,
	CHAT_IMPORTANT_MESSAGES: `/api/chat/${version}/messages/important/`,
	CHAT_LIST: `/api/chat/${version}/my-chats/`,
	MARK_DONE: `/api/chat/${version}/messages/:message_id/done/`,
	ROOM_WEBSOCKET: '/ws/chat/:chat_id/',
	LOGOS_LIST: `api/${version}/letters/logos/`,
	SIGNS_LIST: `api/${version}/letters/stamps/`,
