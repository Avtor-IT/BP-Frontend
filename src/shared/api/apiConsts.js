...
export const apiEndpoints = {
	...
	GET_UPLOADED_FILE: `/api/hooks/download-uploaded-file/:file_id/` /* должны быть urlParams */,
	GET_DEPARTMENT: `/api/hooks/department/`,
	CHAT_ROOM: `/api/chat/:b24_user_id/` /* to edit */,
	CHAT_MESSAGES: `/api/chat/:chat_room_id/messages/ ` /* to edit */,
	MANAGER_MESSAGES: `/api/chat/manager/messages/`,
	CHAT_IMPORTANT_MESSAGES: `/api/chat/messages/important/` /* to edit */,
	CHAT_LIST: `/api/chat/my-chats/`,
	MESSAGES_COUNT: 'api/chat/messages/count',
